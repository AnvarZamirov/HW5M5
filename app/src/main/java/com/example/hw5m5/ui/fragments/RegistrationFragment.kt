package com.example.hw5m5.ui.fragments
...
import com.example.hw5m5.RegistrationView
import com.example.hw5m5.databinding.FragmentRegistrationBinding
...
class RegistrationFragment : Fragment(), RegistrationView {
    ...
    override fun showSuccessResult(result: PercentageModel) {
        val action =
            RegistrationFragmentDirections.actionRegistrationFragmentToLoveResultFragment(
